...
public class ScorePastille extends Pastille {
    ...
    public ScorePastille(Vector2 position, World monde, float taille) {
        super(position, monde, taille);
        atlas = new TextureAtlas(Gdx.files.internal("Donnees/images/pastilleNormale.pack"));
    ...
    @Override
    public void effect() {
        SoundFactory.getInstance().playPastille(0.1f);
    }
}
