...
public class SizePastille extends Pastille{
    ...
    public SizePastille(Vector2 position, World monde, float taille) {
        super(position, monde, taille);
        atlas = new TextureAtlas(Gdx.files.internal("Donnees/images/pastilleTaille.pack"));
    ...
    @Override
    public void effect() {
        SoundFactory.getInstance().playPtaille(0.1f);
    }
}
